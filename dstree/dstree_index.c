...
void dstree_node_destroy(struct dstree_node * node, bool is_index_new){
...
void dstree_index_destroy(struct dstree_index *index, struct dstree_node *node, boolean is_index_new)
{
   ...
   dstree_node_destroy(node, is_index_new);
}
...
void destroy_index(struct dstree_index *index, bool is_index_new){
